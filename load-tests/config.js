...
export const CREDS = {
  // В /api/v1/auth/login бэкенд ожидает поле `username` (email/логин).
  // На сервере используются:
  //   admin@recontext.online / admin123
  //   user@recontext.online  / user123
  admin: { username: __ENV.ADMIN_USER || 'admin@recontext.online', password: __ENV.ADMIN_PASS || 'admin123' },
  user:  { username: __ENV.USER_USER  || 'user@recontext.online',  password: __ENV.USER_PASS  || 'user123'  },
};
