...
func (up *UserPortal) GetOrganizationsHandler(w http.ResponseWriter, r *http.Request) {
...
func (up *UserPortal) GetOrganizationHandler(w http.ResponseWriter, r *http.Request) {
...
func (up *UserPortal) CreateOrganizationHandler(w http.ResponseWriter, r *http.Request) {
...
func (up *UserPortal) UpdateOrganizationHandler(w http.ResponseWriter, r *http.Request) {
	// Extract ID from path: /api/v1/organizations/{id}
	pathParts := strings.Split(strings.TrimPrefix(r.URL.Path, "/api/v1/organizations/"), "/")
	if len(pathParts) == 0 || pathParts[0] == "" {
		http.Error(w, "Organization ID is required", http.StatusBadRequest)
...
func (up *UserPortal) DeleteOrganizationHandler(w http.ResponseWriter, r *http.Request) {
	// Extract ID from path: /api/v1/organizations/{id}
	pathParts := strings.Split(strings.TrimPrefix(r.URL.Path, "/api/v1/organizations/"), "/")
	if len(pathParts) == 0 || pathParts[0] == "" {
		http.Error(w, "Organization ID is required", http.StatusBadRequest)
...
func (up *UserPortal) GetOrganizationStatsHandler(w http.ResponseWriter, r *http.Request) {
